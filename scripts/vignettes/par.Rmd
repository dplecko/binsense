...
p_agn <- grid_to_plt(fi_grid[fi_grid$type == "agnostic", ], "two-stage-em",
                     "agnostic")
ggsave(file.path(root, "paper", "figures", "par-agnostic.png"),
       p_agn, width = 6, height = 4)

p_x <- grid_to_plt(fi_grid[fi_grid$type == "x", ], "two-stage-em", "x")
ggsave(file.path(root, "paper", "figures", "par-x.png"), 
       p_x, width = 6, height = 4)

p_y <- grid_to_plt(fi_grid[fi_grid$type == "y", ], "two-stage-em", "y")
