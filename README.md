...
| [Fig. 2](nonpar-agnostic.png): Non-parametric inference of agnostic $\phi$-values | `scripts/vignettes/nonpar.Rmd` (`r nonpar-agnostic`)
| [Fig. 3](nonpar-x.png/nonpar-y.png): Non-parametric inference of $x$- and $y$-specific $\phi$-values. | `scripts/vignettes/nonpar.Rmd` (`r x-grid`, `r y-grid`)
| [Fig. 4](nonpar-x-axis-ci.png): Non-parametric $x$-specific $\phi$-values with uncertainty quantification. | `scripts/vignettes/nonpar.Rmd` (`r axis-search-ci`)
| [Fig. 5](#): Inference of $\phi$-values for the parametric exponential family model. | `scripts/vignettes/par.Rmd` (`r ?`)
| [Fig. 6](#): Parametric $x$-specific $\phi$-values with uncertainty quantification. | `scripts/vignettes/par.Rmd` (`r ?`)
